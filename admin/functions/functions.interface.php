...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page( THEMENAME, 'Portfolio', 'edit_theme_options', 'northeme_framework', 'optionsframework_options_page',ADMIN_DIR.'/assets/images/northeme_admin.png',58);
