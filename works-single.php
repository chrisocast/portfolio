...
<div id="singlecontent">
		...
		<div class="columns navibg border-color">
            <div class="seven columns alpha works-title">
            	<h3><?php _e('Works','dronetv'); ?> ></h3> <h1><?php echo get_the_title( $ID ); ?></h1>
            </div>
            ...
            <div class="nine columns omega">
            	<div class="navigate">
                    ...
                    <?php if(!empty( $prev_post['ID'] )) { ?>
                      <a href="<?php echo get_permalink($prev_post['ID']); ?>" data-type="works" data-token="<?php echo $token?>" data-id="<?php echo $prev_post['ID']?>" title="Previous work: <?php echo htmlspecialchars($prev_post['post_title'])?>" class="navigate back getworks-nextback getworks-showmsg">&nbsp;</a>
                    <?php } ?>
                    <?php if(!empty( $next_post['ID'] )) { ?>
                      <a href="<?php echo get_permalink($next_post['ID']); ?>" data-type="works" data-token="<?php echo $token?>" data-id="<?php echo $next_post['ID']?>" title="Next work: <?php echo htmlspecialchars($next_post['post_title'])?>" class="navigate next getworks-nextback getworks-showmsg">&nbsp;</a>
					          <?php } ?>
            	</div>
            </div>	
        </div>
